      ...
      <section className="mx-auto max-w-5xl px-4 py-12 md:px-6 md:py-16">
        <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-xl shadow-slate-900/5 md:p-10">
          ...
          <h1 className="text-3xl font-black leading-tight text-slate-950 md:text-5xl">
            Öğrenci Takibi ve Hedef Odaklı Destek
          </h1>

          <p className="mt-5 text-base leading-8 text-slate-600 md:text-lg">
            Bu alan, öğrencinin çalışma düzenini daha kontrollü hale getirmek,
            hedef belirlemek ve süreci daha sistemli yürütmek için hazırlanıyor.
            Burada ilerleyen aşamada koçluk yapısı, planlama akışları ve takip
