            ...
            <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                {[
                  ...
                  <div
                    key={stat.label}
                    className="rounded-[1.45rem] border border-white/30 bg-white/95 p-5 shadow-lg shadow-slate-900/10 backdrop-blur-sm"
                  >
          ...
          <div className="mb-6 flex flex-wrap gap-2.5">
            {gradeCounts.map((item) => (
              <Link
                ...
                className="rounded-full border border-blue-200 bg-white px-4 py-2 text-sm font-bold text-blue-800 transition hover:bg-blue-50"
              >
                {item.grade}. Sınıf: {item.count}
              </Link>
            ))}
          </div>
