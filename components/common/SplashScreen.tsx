...
export default function SplashScreen({ onFinish }: { onFinish?: () => void }) {
  ...
  useEffect(() => {
    const t1 = window.setTimeout(() => setPhase("hold"), 220);
    const t2 = window.setTimeout(() => setPhase("exit"), 760);
    const t3 = window.setTimeout(() => onFinish?.(), 1040);
  ...
  return (
    <>
      <style>{`
        .ps {
          ...
          background:
            ...
            radial-gradient(ellipse at 82% 22%, rgba(234, 88, 12, 0.3) 0%, transparent 42%),
        ...
        .ps--exit {
          animation: psExit 0.22s cubic-bezier(0.4, 0, 1, 1) forwards !important;
        }
        ...
        .ps__ambient {
          ...
          height: 52rem;
          border-radius: 50%;
          background: radial-gradient(ellipse, rgba(29, 79, 145, 0.4) 0%, transparent 65%);
          pointer-events: none;
        }
        ...
        .ps__card {
          ...
          text-align: center;
          animation: psCardIn 0.28s cubic-bezier(0.18, 0.88, 0.32, 1.02) both;
          overflow: hidden;
        }
        ...
        .ps__card::after {
          ...
          bottom: 0;
          height: 60%;
          background: radial-gradient(ellipse at 50% 120%, rgba(234, 88, 12, 0.1) 0%, transparent 70%);
          pointer-events: none;
        }
        ...
        .ps__logo {
          ...
          animation: psLogoFloat 2.8s ease-in-out infinite;
        }
        ...
        @keyframes psExit {
          ...
          100% { opacity: 0; transform: scale(1.014); visibility: hidden; }
        }
      ...
      <div className={`ps${phase === "exit" ? " ps--exit" : ""}`}>
        ...
        {SYMBOLS.map(({ symbol, x, y, size, opacity, delay, duration }, index) => (
          <span
            key={index}
            className="ps__sym"
            aria-hidden="true"
        ...
        <div className="ps__card">
          ...
          <p className="ps__sub">Matematik için düzenli ve güvenilir dokümanlar</p>
